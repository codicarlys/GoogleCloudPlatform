...
import com.google.cloud.teleport.util.AvroSchemaUtil;
import com.google.cloud.teleport.util.StructUtil;
import com.google.cloud.teleport.util.converter.StructToRecordConverter;
...
public class StructToAvroTransform extends PTransform<PCollection<Struct>, WriteFilesResult<String>> {
    ...
    private final ValueProvider<String> fileName;
    ...
    private String strDate = FormatDate.format(date) + '/';

    public StructToAvroTransform(ValueProvider<String> output, ValueProvider<String> fileName ,ValueProvider<String> keyField, ValueProvider<Boolean> useSnappy) {
        this.output = output;
        ...
        return records.get(tagMain)
                .apply("WriteStructDynamically", FileIO.<String, KV<String, Struct>>writeDynamic()
                        ...
                        .withNaming(key -> FileIO.Write.defaultNaming(
                                buildPrefixFileName( this.fileName.get(), key), ".avro"))
    ...
    private static String buildPrefixFileName(String fileName, String key) {
        ...
        // String fullPath = output + fileName + '/' + strDate + '/' + fileName;
